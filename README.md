...
[![NPM version](<https://img.shields.io/npm/v/taggy.svg?label=npm%20(stable)>)](https://npmjs.org/package/taggy) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/taggy)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/taggy-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install taggy`
...
1. Via the `TAGGY_LOG` environment variable
...
const client = new Taggy({
  logger: logger.child({ name: 'Taggy' }),
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/taggy-typescript/issues) with questions, bugs, or suggestions.
