...
export interface ClientOptions {
   ...
   * Set the log level.
   *
   * Defaults to process.env['TAGGY_LOG'] or 'warn' if it isn't set.
   */
...
export class Taggy {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Taggy.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('TAGGY_LOG'), "process.env['TAGGY_LOG']", this) ??
      defaultLogLevel;
  ...
  static TaggyError = Errors.TaggyError;
